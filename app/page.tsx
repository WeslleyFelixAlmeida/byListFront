...
export default function Home() {
  return (
    <section className="w-full h-full p-5 flex flex-col gap-y-2.5">
      <div className="w-full flex justify-between">
        <h1 className="text-blue-950 font-bold text-2xl">Lista de compras:</h1>
        <button className="bg-green-600 w-10 sm:w-48 h-10 rounded-xl text-xl font-bold cursor-pointer hover:bg-green-700 transition[background-color] duration-500 flex items-center justify-center gap-x-2.5">
          +
